...
class MainActivity : AppCompatActivity() {
    ...
    fun abrirActividadConParametros(
        ...
        intentExplicito.putExtra("nombre", "Andrea")
        intentExplicito.putExtra("apellido", "Garces")
        intentExplicito.putExtra("edad", 22)
        intentExplicito.putExtra("entrenadorPrincipal", BEntrenador(1, "Andrea", "Paleta"))
